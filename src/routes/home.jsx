    ...
    /* -------------------------------------------------------------------------- */}
      <div className="worldmap-bg" style={{padding: '5%'}}>
        <Container maxWidth="sm" sx={{textAlign: 'center', mt: '5%'}}>
            ...
            <Typography variant="h5" sx={{fontWeight:'none', mt:4, display: {xs:'none', md:'block'}}}>Flight Bucks is an open source project aimed at improving the Aviation Experience of India.</Typography>
            <Typography  sx={{fontWeight:'none', mt:2, display: {xs:'block', md:'none'}}}>Flight Bucks is an open source project aimed at improving the Aviation Experience of India.</Typography>

            <div style={{marginTop:'8%'}}>
              <Button onClick={() => {window.location.href="/flights"}} className="indigo-btn" sx={{px: '5%'}}>Search Flights</Button>
              <Button onClick={() => {window.location.href="https://github.com/komalupadhyaya/Flight-Bucks.git"}} className="gray-btn" sx={{ml:2, px: '7%'}}>Github &nbsp; <ArrowForwardIosIcon sx={{fontSize: '0.8rem'}} /></Button>
            </div>
      ...
      <Container maxWidth='lg' sx={{mt:8}}>
        ...
        <Grid container>
          <Grid item md={6} xs={12} sx={{textAlign:'left'}}>
            ...
            <Typography>
            One of the key advantages of using Flight Bucks is its ability to find affordable flight tickets. The website is designed to prioritize cost-effective options, ensuring that you get the best value for your money. By comparing prices from various airlines, Flight Bucks helps you identify the most budget-friendly flights available. Whether you&apos;re a budget traveler or simply looking to save some extra cash, Flight Bucks is the perfect platform to find cheap flight tickets.
            </Typography>
          </Grid>
        ...
        <Grid container sx={{mt:10}}>
          ...
          <Grid item md={6} xs={12} sx={{textAlign:'left'}}>
            ...
            <Typography>
            Sometimes, plans change at the last minute, and you find yourself in need of a flight ticket urgently. Flight Bucks understands this and offers a feature that allows you to search for last-minute flight deals. Whether you need to attend a business meeting or want to surprise your loved ones with a spontaneous trip, Flight Bucks can help you find the best last-minute flight options. With its extensive network of airlines and travel partners, you can trust Flight Bucks to find the most convenient and affordable flights, even on short notice.
            </Typography>
          </Grid>
        ...
        <Grid container sx={{mt:10}}>
          <Grid item md={6} xs={12} sx={{textAlign:'left'}}>
            ...
            <Typography>
            Flight Bucks fosters a sense of community among developers, allowing them to collaborate and contribute to the platform&apos;s development. This collaborative approach ensures that the platform continues to evolve and improve, benefiting all users.
            </Typography>
            <Typography variant="h5" className='fw-700' sx={{mt:4, textAlign: 'center'}}>Join the Developer Community</Typography>
            <Typography sx={{mt:1, textAlign: 'center'}}>By Contributing to the Flight Bucks Github Repository.</Typography>
            <div style={{textAlign:'center'}}>
              <Button className="indigo-btn" onClick={() => {window.location.href="https://github.com/komalupadhyaya/Flight-Bucks.git"}} sx={{mt:2, px:4}}>Join Community</Button>
            </div>
          </Grid>
